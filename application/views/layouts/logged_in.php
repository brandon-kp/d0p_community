		...
		<div id="wrap">
			<div id="header">
				<ul id="top_menu">
					...
					<li<?php if($notifications['new_messages']):echo' class="NewMail"';endif;?>><a href="<?php echo site_url('messages');?>">My Messages</a></li>
					<li><a href="<?php echo site_url('userprofile/index/~'.$userprofile['id']);?>">My Profile</a></li>
